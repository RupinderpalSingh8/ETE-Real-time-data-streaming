...
def connect_to_kafka(spark_conn):
    spark_df = None  # Initialize spark_df outside the try block
    ...
    return spark_df  # Ensure return is properly indented
...
def create_cassandra_connection():
    ...
    try:
        ...
        logging.error(f"Couldn't create cassandra session due : {e}")
    return None
